...
ActiveRecord::Schema[7.0].define(version: 20_240_627_234_109) do
  ...
  create_table 'trap_counts', force: :cascade do |t|
    ...
    t.index %w[user_id riddle_id level], name: 'index_trap_counts_on_user_id_and_riddle_id_and_level',
                                         unique: true
